...
INSERT INTO users (id, email, password_hash, role, status, first_name, last_name) VALUES
  (uuid_generate_v4(), 'cadre@ged.gov.ma',      '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'CADRE',       'ACTIVE', 'Ahmed',   'Benali'),
  (uuid_generate_v4(), 'inspecteur@ged.gov.ma', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'INSPECTEUR',  'ACTIVE', 'Fatima',  'Zahra'),
  (uuid_generate_v4(), 'rh@ged.gov.ma',         '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'RH',          'ACTIVE', 'Hassan',  'Moussaoui'),
  (uuid_generate_v4(), 'comptable@ged.gov.ma',  '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'COMPTABLE',   'ACTIVE', 'Karima',  'El Idrissi'),
  (uuid_generate_v4(), 'consultant@ged.gov.ma', '$2b$12$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'CONSULTANT',  'ACTIVE', 'Youssef', 'Amine')
