  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        {/* Notifications */}
        <button className="relative flex h-9 w-9 items-center justify-center rounded-xl transition-colors hover:bg-white/8"
        ...
        <div ref={menuRef} className="relative">
          <button
            ...
            className="flex items-center gap-2.5 rounded-xl px-3 py-2 transition-colors hover:bg-white/8"
            style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)' }}
          >
            ...
            >
              ...
              <div className="py-1">
                <button
                  ...
                  className="flex w-full items-center gap-2.5 px-4 py-2.5 text-sm text-slate-300 hover:bg-white/8 hover:text-white transition-colors"
                >
